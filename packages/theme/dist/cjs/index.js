...
var _vechaiProvider = require("./vechai-provider");
Object.keys(_vechaiProvider).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _vechaiProvider[key]) return;
  exports[key] = _vechaiProvider[key];
});
